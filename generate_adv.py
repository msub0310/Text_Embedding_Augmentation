...
CUSTOM_MODEL_NAME = f"PGD_BATCH{BATCH_SIZE * ACCUMULATION_STEPS}_EPS{EPSILON}_ALPHA{ALPHA}_STEP{ADV_STEP}"
...
attack = PGD(model, eps=EPSILON, alpha=ALPHA, steps=ADV_STEP)
...
for epoch in range(EPOCHS):
    ...
    if epoch < START_ATTACK_EPOCH:
        ...
        #train_acc, train_loss, adversarial_examples, adversarial_labels = generate_adversarial_examples_epoch(
        train_acc, train_loss = generate_adversarial_examples_epoch(    
            model,
            attack,
            train_data_loader,
            loss_fn,
        ...
        #with open(save_path + f"/adversarial_examples_epoch_{epoch}.pickle", "wb") as f:
        #    pickle.dump(adversarial_examples, f, pickle.HIGHEST_PROTOCOL)

        #with open(save_path + f"/adversarial_labels_epoch_{epoch}.pickle", "wb") as f:
        #    pickle.dump(adversarial_labels, f, pickle.HIGHEST_PROTOCOL)

        #print(f"saved adversarial examples EPOCH{epoch}\n")
